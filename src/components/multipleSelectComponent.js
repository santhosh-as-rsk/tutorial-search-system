            ...
            <Container fluid className="mt-5"> 
                <Row className="justify-content-center"> 
                    <Col xs={12} md={6} lg={4} className="mb-3"> 
                        <AutocompleteMultipleSelect topics={topics} reff={1} selectedTopics={selectedTopics} setSelectedTopics={setSelectedTopics} labelName='Topics' />
                    </Col>
                    
                    <Col xs={12} md={6} lg={4} className="mb-3 mx-auto"> 
                        <AutocompleteMultipleSelect topics={subTopics} reff={2} selectedTopics={selectedSubTopics} setSelectedTopics={setSelectedSubTopics} labelName='Sub Topics' />
                    </Col>
